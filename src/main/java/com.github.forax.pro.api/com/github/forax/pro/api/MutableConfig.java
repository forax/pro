...
public interface MutableConfig extends Config {
  /**
   * Returns the value associated with the key or use vivification
   * to dynamically create an object implementing the interface {@code type}.
   * 
   ...
   * @param value a value
   * 
   * @throws ClassCastException if the component prefix is a vivified object and
   *         the value is not a subclass of the type of the getter method of the
   *         interface used to create the vivified object. 
   * @throws IllegalStateException if one of the component of the key is not a tree node.
   */
