...
public class Bootstrap {
  public static void main(String[] args) throws IOException {
    ...
    set("linker.launchers", list("pro=com.github.forax.pro.main/com.github.forax.pro.main.Main"));
    set(
        "linker.rootModules",
        list(
                ...
                "com.github.forax.pro.daemon.imp") // then add all system modules
            .appendAll(
    ...
    compileAndPackagePlugin(
        ...
        () -> {
          ...
          download(
              base + "-" + version + "/google-java-format-" + version + "-all-deps.jar",
    ...
    local(
        ...
        () -> {
          ...
          set(
              ...
              path("plugins/" + name + "/deps", "target/main/artifact/", "deps"));
          set("compiler.upgradeModulePath", path("target/main/artifact/", "deps"));
