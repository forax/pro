...
public class Main {
  ...
  public static void main(String[] args)
        ...
        new ModuleFinder() {
          ...
          public Set<ModuleReference> findAll() {
            return finder
                .findAll()
                .stream()
                .map(ref -> find(ref.descriptor().name()).get())
          ...
          public Optional<ModuleReference> find(String name) {
            ...
            if (main == null) {
              ...
              builder.exports(
                  packageOf(mainClassName), Set.of("com.github.forax.pro.uberbooter")); // patch !
              ...
              packages.removeAll(
                  descriptor.opens().stream().map(Opens::source).collect(Collectors.toSet()));
              packages.remove(packageOf(mainClassName));
              builder.packages(packages);

              main =
                  new ModuleReference(builder.build(), ref.location().get()) {
                    @Override
    ...
    Configuration cf =
        parent
            ...
            .resolveAndBind(
                patchedFinder,
                ModuleFinder.of(),
                List.of("com.github.forax.pro.uberbooter", mainModule));
    ModuleLayer layer =
        ModuleLayer.defineModulesWithOneLoader(
                cf, List.of(parent), ClassLoader.getSystemClassLoader())
            .layer();
    ...
    try {
      MethodHandle mh =
          lookup.findStatic(
              booterClass, "main", MethodType.methodType(void.class, Class.class, String[].class));
